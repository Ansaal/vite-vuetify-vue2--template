...
type ResolveIdResult = string | false | null | void | PartialResolvedId;
...
type IsPureModule = (id: string) => boolean | null | void;
...
type GetManualChunk = (id: string, api: GetManualChunkApi) => string | null | void;
